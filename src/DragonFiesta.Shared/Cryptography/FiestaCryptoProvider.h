#ifndef FIESTA_CRYPTOPROVIDER_H
#define FIESTA_CRYPTOPROVIDER_H

#include "../Define.h"
#include <vector>

class FiestaCryptoProvider
{
public :
    FiestaCryptoProvider() = delete;
    FiestaCryptoProvider(const int16& offset);
private :

    int16 XorPos;
    void Crypt(std::vector<unsigned char>& ByteBuffer);
    void Crypt(std::vector<unsigned char>& pBuffer,const int32& pOffset,const int32& pLen);

    unsigned char XorTable[499] =
    {
