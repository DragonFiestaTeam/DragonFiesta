...
namespace Zepheus.Zone.Game
{
    public sealed class ZoneCharacter : MapObject
    {
        ...
        public bool Male { get { return character.LookInfo.Male; } set { character.LookInfo.Male = value; } }
                ...
                character.PositionInfo.Map = (byte)Map.MapID;
                     ...
                     DateTime start = DateTime.Now;
                       try
                       {
                           ...
                           //this.IsSaving = true;
                            Program.CharDBManager.GetClient().ExecuteQuery("UPDATE Characters SET XPos=" + character.PositionInfo.XPos + ", YPos=" + character.PositionInfo.YPos + ", Map=" + character.PositionInfo.Map + ", Level=" + character.CharLevel + ", Job=" + character.Job + ", CurHP=" + character.HP + " , CurSP=" + character.SP + ", Exp=" + character.Exp + " , Money=" + character.Money + ", Hair=" + character.LookInfo.Hair + " , HairColor=" + character.LookInfo.HairColor + " , Face=" + character.LookInfo.Face + " , StatPoints=" + character.StatPoints + " , Str=" + character.CharacterStats.StrStats + " , End=" + character.CharacterStats.EndStats + " , Dex=" + character.CharacterStats.DexStats + " , StrInt=" + character.CharacterStats.IntStats + " , Spr="+character.CharacterStats.StrStats+" , GuildID=" + character.GuildID + " , UsablePoints="+character.UsablePoints+" WHERE CharID=" + character.ID + "");
        ...
        public void MoveItem(sbyte fromslot, sbyte toslot)
        {
            ...
            if (to != null)
            {
                if (to.Info.Type == ItemType.Equip)
                {
                    Program.CharDBManager.GetClient().ExecuteQuery("UPDATE Equips SET Slot='" + to.Slot + "' WHERE Owner='" + to.Owner.ID + "' AND Slot='" + fromslot + "' ");
                }
                else
                {
                    Program.CharDBManager.GetClient().ExecuteQuery("UPDATE Items SET Slot='" + to.Slot + "' WHERE Owner='" + to.Owner.ID + "' AND Slot='" + fromslot + "' ");
                }
